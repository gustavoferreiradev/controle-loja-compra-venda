...
public class FXMLMarcaListaController implements Initializable {
    ...
    @FXML
    private TableColumn<Marca, Integer> columnId;
    @FXML
    private TableColumn<Marca, String> columnNome;
    @FXML
    private Button buttonEdit;

    private MarcaDao marcaDao;
    private ObservableList<Marca> list
    ...
    private void loadData() {
        this.list.clear();
        this.list.addAll(this.marcaDao.getAll());
