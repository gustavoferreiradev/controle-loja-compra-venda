...
public class FXMLFormaPagamentoListaController implements Initializable {

    @FXML
    private TableView<FormaPagamento> tableData;
    @FXML
    private TableColumn<FormaPagamento, Integer> columnId;
    @FXML
    private TableColumn<FormaPagamento, String> columnDescricao;
    @FXML
    private Button buttonEdit;

    private FormaPagamentoDao formaPagamentoDao;
    private ObservableList<FormaPagamento> list
    ...
    private void loadData() {
        this.list.clear();
        this.list.addAll(this.formaPagamentoDao.getAll());
        tableData.setItems(list);
    }

    private void openForm(FormaPagamento formaPagamento,
            ActionEvent event) {
        try {
            ...
            loader.setLocation(
                    this.getClass()
                            .getResource("/fxml/FXMLFormaPagamentoCadastro.fxml"));
            AnchorPane pane = (AnchorPane) loader.load();

            //Criando o stage para o modal
            Stage dialogStage = new Stage();
            dialogStage.setTitle("Cadastro de Formas de Pagamento");
            ...
            FXMLFormaPagamentoCadastroController controller
                    = loader.getController();
            controller.setFormaPagamento(formaPagamento);
    ...
    private void edit(ActionEvent event) {
        FormaPagamento formaPagamento
                = tableData.getSelectionModel()
                        .getSelectedItem();
        this.openForm(formaPagamento, event);
    }

    @FXML
    private void newRecord(ActionEvent event) {
        this.openForm(new FormaPagamento(), event);
    }
    ...
    private void delete(ActionEvent event) {
        if (tableData.getSelectionModel()
                .getSelectedIndex() >= 0) {
            try {
                FormaPagamento formaPagamento = tableData
